...
public static class AsyncRewriter {
    ...
    private static ClassDecl.Class InjectInoculationFields(Class classRef, string[] interceptorsClasses, Func<MethodDefinition, MethodDefinition[]> MoveNextHandler)
    {
    ...
    private static Func<ClassDecl.MethodDefinition, ClassDecl.MethodDefinition[]> GetNextMethodHandler(TypeData returnType, Class classRef, IEnumerable<string> path, bool isReleaseMode, string[] interceptorClasses)
    {
        int labelIdx = 0;
